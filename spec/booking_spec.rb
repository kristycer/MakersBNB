...
describe 'booking' do
  ...
  booking = Booking.create(property_name: 'Test Property', booking_date: '2020-10-03' , total_price: 5.00, name: 'User Example', email: 'exampleowner@me.com', owner_id: owner.id )
